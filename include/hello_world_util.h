...
inline void *mem_type_malloc(size_t length)
{
    void *ptr;
...
inline void mem_type_free(void *address)
{
    switch (test_mem_type)
    {
    case UCS_MEMORY_TYPE_HOST:
...
inline void *mem_type_memcpy(void *dst, const void *src, size_t count)
{
    switch (test_mem_type)
    {
    case UCS_MEMORY_TYPE_HOST:
...
inline void *mem_type_memset(void *dst, int value, size_t count)
{
    switch (test_mem_type)
    {
    case UCS_MEMORY_TYPE_HOST:
...
inline int check_mem_type_support(ucs_memory_type_t mem_type)
{
    switch (mem_type)
    {
    case UCS_MEMORY_TYPE_HOST:
...
inline ucs_memory_type_t parse_mem_type(const char *opt_arg)
{
