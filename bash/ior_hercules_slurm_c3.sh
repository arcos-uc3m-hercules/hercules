...
#SLURM_HOSTFILE=./$HERCULES_MPI_HOSTFILE_NAME
# srun -N 16 -n 256 \
#    --export=ALL,HERCULES_CONF=$HERCULES_CONF,LD_PRELOAD=$HERCULES_POSIX_PRELOAD \
#    $COMMAND
...
#/home/tester004/gesanche/hercules/scripts/hercules stop \
#	   -f "$CONFIG_PATH"
