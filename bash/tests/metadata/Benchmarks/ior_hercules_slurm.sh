...
#COMMAND="$COMMAND -o /mnt/hercules/directory_/data.out"
COMMAND="$COMMAND -o /mnt/hercules/data.out"

#COMMAND="cp /beegfs/home/javier.garciablas/hercules/bash/tests/disk/HerculesSnapshot/upload_file /mnt/hercules/data.out"
