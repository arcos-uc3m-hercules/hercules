...
##SBATCH --nodefile=/home/tester004/gesanche/hercules/tmp/hostfile_6249
...
#UCX_TCP_KEEPINTVL=inf UCX_TCP_KEEPIDLE=inf
#export UCX_NET_DEVICES="ib0,mlx5_0:1"
#export UCX_TLS=ib
...
COMMAND="$IOR_PATH/ior -w -r -W -R -t ${TRANSFER_SIZE}kb -b ${FILE_SIZE_PER_CLIENT}kb -s 1 -i 5 -K"
