...
#SBATCH --output=logs/beegfs/%j.log   # Standard output and error log
#SBATCH --mem=0
##SBATCH --overcommit
...
# COMMAND="$IOR_PATH/ior -w -r -k -e -t ${TRANSFER_SIZE}kb -b ${FILE_SIZE_PER_CLIENT}kb -s 1 -i 5 -F -o /beegfs/home/javier.garciablas/hercules/bash/ior_output/data.txt"
# else
